...
/*
  ...
  * GET @ /api/home/woodShopStatus
    ? Returns count of students in woodshop
    ? Current open/close of woodshop
  * GET @ /api/home/laserLabStatus
  * GET @ /api/home/printQueueStatus

*/

// No Active Login Required
router.get("/woodShopStatus", (req, res, next) => {
  console.log("GET @ /api/home/woodShopStatus");

  // !DeptInfo.findOne( {deptName: })
  // Need to pick up here after creating admin page to manage depts
})
        ...
        .then(documents => {
            ...
            EmailHistory.find()
              .then(emailHistDocuments => {
                ...
                res.status(200).json({
                  message: 'All Email Accounts and Email History fetched successfully!',
